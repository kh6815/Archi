...
//    @Transactional(rollbackFor = Exception.class)
//    public List<FileEntity> saveFileAll(List<MultipartFile> fileList) throws CustomException {
//        List<FileEntity> willSaveFileEntityList = new ArrayList<>();
//
//        if(checkValidFileList(fileList)){
...
//                        .build();
//
//                willSaveFileEntityList.add(fileEntity);
//            }
//
//            List<FileEntity> saveFileEntityList = fileRepository.saveAll(willSaveFileEntityList);
//
//            return saveFileEntityList;
//        }
//
//        return willSaveFileEntityList;
//    }
//
//    public Boolean checkValidFileList(List<MultipartFile> fileList) throws CustomException {
//        for (MultipartFile file : fileList) {
//            String fileName = file.getOriginalFilename();
//
//            if (!StringUtils.hasText(fileName)) {
